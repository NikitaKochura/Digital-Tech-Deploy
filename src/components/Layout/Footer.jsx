    ...
    <footer className="w-full bg-[#050505] border-t border-white/5 pt-20 pb-10 px-8 md:px-20 mt-auto z-10 relative">
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
        ...
        <div className="md:col-span-4 flex flex-col md:items-end text-left md:text-right">
          ...
          <a href="mailto:support@digitaltech.ru" className="text-gray-500 text-sm hover:text-white transition-colors mb-4">support@digitaltech.ru</a>
          <p className="text-gray-500 text-xs mb-8 leading-relaxed">
            Рабочее время: 10:00-18:00<br/>
            Понедельник-Пятница GMT+3<br/>
            ВКонтакте: <a href="#" className="text-blue-500 hover:text-blue-400">Связаться в ЛС</a>
          </p>

          <div className="flex flex-col gap-3 md:items-end mb-8">
            <a href="#" className="text-white text-xs hover:text-gray-300 transition-colors">Политика конфиденциальности</a>
            <a href="#" className="text-white text-xs hover:text-gray-300 transition-colors">Пользовательское соглашение</a>
          </div>
      ...
      <div className="max-w-[1400px] mx-auto flex items-center justify-between">
        ...
        <p className="text-gray-600 text-[10px] uppercase tracking-widest hidden md:block">Your «D» Side</p>
      </div>
    </footer>
  );
}
